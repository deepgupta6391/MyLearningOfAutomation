...
public class PracticingRestFul_Booker {
	...
	@Test(enabled = false)
	public void deleteBookingReturns201and404AfterRecheck() {
		System.out.println("-------------------------------------------");
		RestAssured.baseURI="https://restful-booker.herokuapp.com";
		...
		Response respone3=request2.get("/booking/"+String.valueOf(bookingId));
		
		System.out.println(respone3.getStatusLine());
