		...
		public static void main(String arg[]) throws IOException {
			try {
				String contents = new String(Files.readAllBytes(
						Paths.get("./src/test/java/XMLUtil/Sample.xml")));

				System.out.println(contents);

				XmlParser xp = new XmlParser(contents);

				String h = xp.getTextContent("//catalog//catalog_item//item_number");
				System.out.println(h);

				List<Element> itemsList = xp.getElements("//catalog//catalog_item//item_number");
				...
				List<Element> pList = xp.getElements("//catalog//catalog_item//size/color_swatch");
