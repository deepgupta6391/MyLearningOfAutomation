...
public class LoginTest {
	...
	public void loginTest() {
		driver.findElement(username).sendKeys("deep.gupta.6391@gmail.com");
		driver.findElement(password).sendKeys("Lovely@1234");
